...
define('dummy/tests/locales/en/translations.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/translations.js should pass jscs', function () {
    ok(false, 'locales/en/translations.js should pass jscs.\nLine must be at most 160 characters at locales/en/translations.js :\n   176 |    },\n   177 |    \'index\': {\n   178 |      \'greeting\': \'Добрый день! Пожалуйста поучаствуйте в финальном тестировании разработанной библиотеки. В случае согласия нажмите на кнопку «ТЕСТ» остальное все выполнится автоматически (Выполнение теста может занять от 5 до 15 секунд). Заранее спасибо :)  \'\n-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------^\n   179 |    },\n   180 |');
  });
});
...
define('dummy/tests/locales/ru/translations.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/translations.js should pass jscs', function () {
    ok(false, 'locales/ru/translations.js should pass jscs.\nLine must be at most 160 characters at locales/ru/translations.js :\n   186 |    },\n   187 |    \'index\': {\n   188 |      \'greeting\': \'Добрый день! Пожалуйста поучаствуйте в финальном тестировании разработанной библиотеки. В случае согласия нажмите на кнопку «ТЕСТ» остальное все выполнится автоматически (Выполнение теста может занять от 5 до 15 секунд). Заранее спасибо :) \'\n----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------^\n   189 |    },\n   190 |');
  });
});
